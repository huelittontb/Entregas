...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -I/home/jubi/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include -I/home/jubi/entregas_app_mobile/.buildozer/android/platform/build-armeabi-v7a_arm64-v8a/build/python-installs/HuelittonEntregas/armeabi-v7a/include/python3.1" ],
  CPPINCLUDES => [  ],
  CXX => "/home/jubi/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC",
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)armv7a-linux-androideabi21-clang",
  minor => "1.1",
  ...
  perl_version => "5.38.2",
  perlargv => [ "shared", "no-dso", "no-asm", "android-arm", "-D__ANDROID_API__=21" ],
  perlenv => {
      ...
      "PERL" => undef,
      "RANLIB" => "/home/jubi/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ranlib",
      "RC" => undef,
      "RCFLAGS" => undef,
      "WINDRES" => undef,
      "__CNF_CFLAGS" => undef,
